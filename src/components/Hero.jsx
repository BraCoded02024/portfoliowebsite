...
export function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative flex h-full min-h-0 flex-col justify-center overflow-hidden bg-surface px-4 py-8 sm:px-6"
    >
      <div
      ...
      <div className="relative mx-auto grid w-full max-w-6xl gap-10 lg:grid-cols-[1fr_auto] lg:items-center lg:gap-12">
        <motion.div
